...
@pytest.mark.parametrize("address", hex_addresses_true + hex_addresses_false)
...
@pytest.mark.parametrize("address_bytes", binary_addresses_true + binary_addresses_false)
...
@pytest.mark.parametrize("address", hex_addresses_true + hex_addresses_false + binary_addresses_true + binary_addresses_false)
...
@pytest.mark.parametrize("address", hex_addresses_true)
...
@pytest.mark.parametrize("address1,address2", address_pairs_true + address_pairs_false)
