...
@pytest.mark.parametrize("number,unit", from_wei_cases)
...
@pytest.mark.parametrize("number,unit", to_wei_cases)
...
@pytest.mark.parametrize("number,decimals", from_wei_decimals_cases)
...
@pytest.mark.parametrize("number,decimals", to_wei_decimals_cases)
