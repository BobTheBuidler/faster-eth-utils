...
@pytest.mark.parametrize("value", identity_cases)
...
@pytest.mark.parametrize("f1,f2,arg", combine_cases)
...
@pytest.mark.parametrize("callback,fn,args", apply_to_return_value_cases)
...
@pytest.mark.parametrize("fn,args", to_tuple_cases)
...
@pytest.mark.parametrize("fn,args", to_list_cases)
...
@pytest.mark.parametrize("fn,args", to_set_cases)
...
@pytest.mark.parametrize("fn,args", to_dict_cases)
